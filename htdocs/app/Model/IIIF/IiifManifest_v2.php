...
//        https://iiif.jacq.org/b/?manifest=https://services.jacq.org/jacq-services/rest/iiif/manifest/1205047
    ...
    protected function mapImageObject(Photos $photo)
    {
        ...
        $imageObject["metadata"][] = ["label"=>"Archive Master file (TIFF)", "value"=>"<a href='".$this->linkGenerator->link("Front:Iiif:archiveImage", [$photo->getArchiveFilename()])."'>download original</a>"];
        return $imageObject;
    }
