...
class User extends \App\Model\Database\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'username', 'password', 'name', 'surname', 'email', 'herbarium', 'role', 'active', 'comment', 'id', 'createdAt', 'lastEdit'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUsername(string $username): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setPassword(string $password): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setEmail(string $email): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setHerbarium(\App\Model\Database\Entity\Herbaria $herbarium): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function getRole(): \App\Model\Database\Entity\UserRole
    {
     ...
     * {@inheritDoc}
     */
    public function setRole(\App\Model\Database\Entity\UserRole $role): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setActive(bool $active): \App\Model\Database\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setComment(?string $comment): \App\Model\Database\Entity\User
    {
